...
describe('when css style is pure CSS', () => {
  test('Frame without children should render only one tag', async () => {
    ...
    expect(buildCode(tag, 'jsx', 'css')).toBe(`const Test: React.VFC = () => {
  return (
    <div className="test" />
  )
}`)
  ...
  test('render frame with children', async () => {
    ...
    expect(buildCode(tag, 'jsx', 'css')).toBe(`const Parent: React.VFC = () => {
  return (
  ...
  test('render Text character', async () => {
    ...
    expect(buildCode(tag, 'jsx', 'css')).toBe(`const Text: React.VFC = () => {
  return (
  ...
  test('render Image node', async () => {
    ...
    expect(buildCode(tag, 'jsx', 'css')).toBe(`const Img: React.VFC = () => {
  return (
    <img src="" />
  )
}`)
...
describe('when css style is styled-components', () => {
  test('Frame without children should render only one tag', async () => {
    ...
    const tag = await modifyTreeForComponent(buildTagTree(frameNode, 'px', new TextCount())!, figma)
    expect(buildCode(tag, 'jsx', 'styled-components')).toBe(`const Test: React.VFC = () => {
  return (
    <Test />
  )
}`)
  ...
  test('render frame with children', async () => {
    ...
    const tag = await modifyTreeForComponent(buildTagTree(parentNode, 'px', new TextCount())!, figma)
    expect(buildCode(tag, 'jsx', 'styled-components')).toBe(`const Parent: React.VFC = () => {
  return (
    <Parent>
      <Child />
    </Parent>
  ...
  test('render Text character', async () => {
    ...
    const tag = await modifyTreeForComponent(buildTagTree(textNode, 'px', new TextCount())!, figma)
    expect(buildCode(tag, 'jsx', 'styled-components')).toBe(`const Text: React.VFC = () => {
  return (
  ...
  test('render Image node', async () => {
    ...
    const tag = await modifyTreeForComponent(buildTagTree(imageNode, 'px', new TextCount())!, figma)
    expect(buildCode(tag, 'jsx', 'styled-components')).toBe(`const Img: React.VFC = () => {
  return (
    <img src="" />
  )
}`)
